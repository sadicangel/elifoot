...
builder.Services.AddDbContext<AppDbContext>(opts => opts.UseSqlite("Data Source=elifoot.db").EnableSensitiveDataLogging().EnableDetailedErrors());
...
using (var scope = app.Services.CreateScope())
{
    ...
    dbContext.Add(sporting);
    dbContext.SaveChanges();

    var stored = dbContext.Set<Club>().Single();
