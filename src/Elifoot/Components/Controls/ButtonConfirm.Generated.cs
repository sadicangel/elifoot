...
partial class ButtonConfirm : MonoGameGum.Forms.Controls.Button
{
    ...
    public static void RegisterRuntimeType()
    {
        ...
        MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(ButtonConfirm)] = template;
